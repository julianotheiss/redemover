  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     <ul class="nav navbar-nav">
		<?php if($this->router->fetch_class() == 'home'){echo "<li class='active'>";} else echo "<li>"?>
		<a href="<?php echo base_url('index.php/home') ?>"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Home Page<span class="sr-only">(current)</span></a></li>
        
		<?php if($this->router->fetch_class() == 'acervo'){echo "<li class='active'>";} else echo "<li>"?>
		...
		<?php if($this->router->fetch_class() == 'autores'){echo "<li class='active'>";} else echo "<li>"?>
		...
		<?php if($this->router->fetch_class() == 'sobre'){echo "<li class='active'>";} else echo "<li>"?>
		...
		<?php if($this->router->fetch_class() == 'contato'){echo "<li class='active'>";} else echo "<li>"?>
	  ...
	  <li class='active'><a href="<?php echo base_url('index.php/welcome') ?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Área do Usuário</a></li>
